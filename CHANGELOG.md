...
- feat[COMPLETE]: Migrated all the steps from zephyr's repo here [#20](https://github.com/parazeeknova/zephyr-forge/pull/20) ([@parazeeknova](https://github.com/parazeeknova) [@pxrsival](https://github.com/pxrsival))
- Update README.md [#20](https://github.com/parazeeknova/zephyr-forge/pull/20) ([@parazeeknova](https://github.com/parazeeknova))
...
- feat[SCRIPT]: Progress goes brrrr [#19](https://github.com/parazeeknova/zephyr-forge/pull/19) ([@parazeeknova](https://github.com/parazeeknova) [@pxrsival](https://github.com/pxrsival))
...
- feat[DOCKER]: Setup successfully goes to dev script [#16](https://github.com/parazeeknova/zephyr-forge/pull/16) ([@parazeeknova](https://github.com/parazeeknova) [@pxrsival](https://github.com/pxrsival))
...
- fix[WORKFLOWS] ([@parazeeknova](https://github.com/parazeeknova))
- fix[WORKFLOW]: More robust workflow for actions ([@parazeeknova](https://github.com/parazeeknova))
